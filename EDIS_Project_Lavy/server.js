...
readpool.getConnection(function(err,connection){
connection.query('SELECT b.productName as pname, a.asin, count(a.asin) as qty from edis.purchaseHistory a, edis.products_r b where a.user =? and a.asin=b.asin group by a.asin',[user], function(err,rows)
	{   
